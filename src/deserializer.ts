...
export interface Field {
  kind: DMMF.Datamodel | DMMF.FieldKind;
  name: string;
  isRequired: boolean;
  isList: boolean;
  isUnique: boolean;
...
function handleAttributes(attributes: Attribute, kind: DMMF.Datamodel | DMMF.FieldKind, type: string) {
...
generator ${name} {
	...
	${output ? handleOutput(output?.value) : ''}
